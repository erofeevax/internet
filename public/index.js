...
class Tasklist {
  ...
  onAddTaskButtonClick = async () => {
    const newTaskName = prompt('Введите название:');
    const nomer = prompt('Введите компанию:');
  ...
  onEditTask = async (taskID) => {
    ...
    const newTaskName = prompt('Введите новое название', oldTaskName[0]);
    const newNomer = prompt('Введите новую компанию', oldTaskName[1]);
